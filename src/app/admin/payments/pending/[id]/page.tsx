...
const mockDatabase = [
  { id: '108496', date: '23 Apr 2024', detectedTime: '09:42 AM', reg: 'ABC 2224', make: 'Toyota Prius (2018)', driver: 'Sarah Miller', fleet: 'Independent', provider: 'Manchester Airport', zone: 'Airport', tier: 'Manual', amountDue: '£85.50', status: 'Driver Notified', userWalletBalance: 'N/A' },
  { id: '108678', date: '23 Apr 2024', detectedTime: '11:15 AM', reg: 'EFG 1035', make: 'BMW 320d (2020)', driver: 'Adam White', fleet: 'Independent', provider: 'London ULEZ', zone: 'ULEZ', tier: 'Manual', amountDue: '£12.50', status: 'Driver Notified', userWalletBalance: 'N/A' },
  { id: '108311', date: '23 Apr 2024', detectedTime: '08:30 AM', reg: 'CVS 2044', make: 'VW Transporter (2021)', driver: 'Emma Rogers', fleet: 'City Logistics Ltd', provider: 'Birmingham CAZ', zone: 'Clean Air Zone', tier: 'Auto-Pay', amountDue: '£120.00', status: 'Payment In Progress', userWalletBalance: '£50.00' },
];
    ...
    <div className="flex flex-col gap-6 pb-10 mt-4 max-w-7xl">
      ...
      <div className="bg-card border border-border rounded-xl shadow-sm p-6 md:p-8 flex flex-col md:flex-row justify-between items-start gap-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Detected on {payment.date}</p>
          <p className="text-xs text-gray-400 mt-0.5">Event Time: {payment.date} {payment.detectedTime}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-card border border-border rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-500">Event Time • Detected</span>
                <span className="font-medium text-foreground">{payment.date} {payment.detectedTime}</span>
              </div>
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-500">Subscription Tier</span>
                <span className={`px-2 py-0.5 rounded text-xs font-medium ${isAutoPay ? 'bg-green-100 text-green-700' : 'bg-purple-100 text-purple-700'}`}>{payment.tier}</span>
              </div>
              <div className="flex justify-between">
        ...
        {/* Right Column: Fully Automated Timeline */}
        <div className="bg-card border border-border rounded-xl shadow-sm p-6 flex flex-col h-full">
          <h2 className="text-lg font-bold text-foreground mb-6 pb-2 border-b border-border">Queue Timeline</h2>
          
          <div className="relative border-l-2 border-gray-200 ml-3 pl-6 flex flex-col gap-6 grow">
            
            {/* The Timeline Flow - matching the manual automated mockup */}
            {!isAutoPay ? (
              <>
                <div className="relative">
                  <div className="absolute -left-8.25 bg-white p-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Apr 23, 2024 09:44 AM</p>
                ...
                <div className="relative">
                  ...
                  <p className="font-bold text-sm text-foreground">Initial Notification Sent to Driver</p>
                  <p className="text-xs text-gray-500 mt-1 italic">"You have entered a chargeable zone"</p>
                  <p className="text-xs text-gray-400 mt-0.5">Apr 23, 2024 10:00 AM</p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="font-bold text-sm text-foreground">Payment Reminder Sent: 18 Hours Remaining</p>
                  <p className="text-xs text-gray-500 mt-1">Apr 23, 2024 3:44 PM</p>
                  <p className="text-xs text-gray-500 mt-0.5 italic">"You have 18 hours to pay this charge"</p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="font-bold text-sm text-foreground">Payment Reminder Sent: 12 Hours Remaining</p>
                  <p className="text-xs text-gray-500 mt-1">Apr 24, 2024 3:44 AM</p>
                  <p className="text-xs text-gray-500 mt-0.5 italic">"You have 12 hours to pay this charge"</p>
                </div>
              </>
            ) : (
              // Auto-Pay Flow
              <>
                <div className="relative">
                  ...
                  <p className="font-bold text-sm text-foreground">Awaiting Top-Up</p>
                  <p className="text-xs text-gray-400 mt-1">Current Status</p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="font-bold text-sm text-foreground">Auto-Pay Attempt Failed</p>
                  <p className="text-xs text-gray-400 mt-1">Apr 23, 2024 10:00 AM — Insufficient Funds</p>
                </div>
            ...
            {/* Note: The "Payment Successful" block from the screenshot mockup only shows up AFTER the payment is made (which routes to the Successful Details page). Therefore, it stays grayed/pending here. */}
