...
//             </div>
//             <h3 className="text-2xl font-bold text-red-600 flex items-end gap-1 mb-1">
//               £2,450.00 <span className="text-xs text-gray-400 font-normal mb-1.5">(14 transactions)</span>
//             </h3>
//             <p className="text-sm text-gray-500 font-medium mt-1">Failed / Expired Payments</p>
//           </Link>
...
//           <h2 className="text-lg font-bold text-foreground">Auto-Pay Pending Queue</h2>
//           <Link href="/admin/payments/pending" className="text-sm text-primary hover:underline font-medium">View All Pending</Link>
//         </div>
...
//                 {[
//                   { reg: 'CVS 2044', driver: 'Emma Rogers', zone: 'Birmingham CAZ', due: '£120.00', balance: '£50.00' },
//                   { reg: 'MW-6901', driver: 'James Wilson', zone: 'London ULEZ', due: '£12.50', balance: '£0.00' },
//                   { reg: 'ABC 2224', driver: 'Sarah Cooper', zone: 'Manchester Airport', due: '£15.00', balance: '£5.00' },
//                 ].map((item, i) => (
...
//                     <td className="px-6 py-4 font-medium text-orange-500">{item.due}</td>
//                     <td className="px-6 py-4 font-medium text-foreground">{item.balance}</td>
//                     <td className="px-6 py-4 text-right">
//                       <button className="text-primary font-medium hover:underline">Process</button>
//                     </td>
//                   </tr>
//                 ))}
//               </tbody>
